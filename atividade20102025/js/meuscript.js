...
function mudaCor(){//função para mudar a cor do texto de preto p/ cinza e cinza p/ preto
    let cor = document.getElementById("cor").style.color;
    if(cor == 'black'){
    document.getElementById("cor").style = "color: gray;";
}else{
    ...
    function onoff(){//função para botao unico que muda a imagem
